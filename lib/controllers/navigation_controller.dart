...
class NavigationController extends GetxController {
  ...
  Future<void> checkAndPromptUserInfo() async {
    final isNameInvalid = name.value.trim().isEmpty || name.value == 'null' || name.value == 's';
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () => _handleProfileUpdate(nameController, addressController),
                        ...
                        Positioned(
                          ...
                          child: GestureDetector(
                            ...
                            child: Icon(Icons.info_outline, size: 20.sp, color: Colors.deepPurpleAccent),
                          ),
                        ),
